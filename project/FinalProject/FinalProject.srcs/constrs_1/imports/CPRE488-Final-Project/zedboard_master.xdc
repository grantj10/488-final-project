...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {JA1_SS[0]}];  # "JA1"
#set_property PACKAGE_PIN AA11 [get_ports {JA2_MOSI}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {JA3_MISO}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {JA4_SCLK}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {JA7_SS[0]}];  # "JA7"
#set_property PACKAGE_PIN AB10 [get_ports {JA8}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {JA9_MISO}];  # "JA9"
set_property PACKAGE_PIN AA8  [get_ports {JA10_SCLK}];  # "JA10"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {JB1_SS[0]}];  # "JB1"
#set_property PACKAGE_PIN W11 [get_ports {JB2}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {JB3_MISO}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {JB4_SCLK}];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports {JB7_SS[0]}];  # "JB7"
#set_property PACKAGE_PIN W10 [get_ports {JB8}];  # "JB8"
set_property PACKAGE_PIN V9 [get_ports {JB9_MISO}];  # "JB9"
set_property PACKAGE_PIN V8 [get_ports {JB10_SCLK}];  # "JB10"

# ----------------------------------------------------------------------------
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN AB6 [get_ports {UART0_TX}];  # "JC1_N"
#set_property PACKAGE_PIN AB7 [get_ports {UART0_TX}];  # "JC1_P"
#set_property PACKAGE_PIN AA4 [get_ports {UART0_RX}];  # "JC2_N"
#set_property PACKAGE_PIN Y4  [get_ports {UART0_RX}];  # "JC2_P"
