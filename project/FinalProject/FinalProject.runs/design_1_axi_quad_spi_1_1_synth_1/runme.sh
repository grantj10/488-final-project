...
HD_PWD='C:/Users/drp1/CPRE488-Final-Project/project/FinalProject/FinalProject.runs/design_1_axi_quad_spi_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_quad_spi_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_quad_spi_1_1.tcl
