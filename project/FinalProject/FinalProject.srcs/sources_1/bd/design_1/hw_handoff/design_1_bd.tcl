...
CONFIG.Multiples16 {4} \
  ...
  # Create instance: clk_wiz_160MHz, and set properties
  set clk_wiz_160MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.4 clk_wiz_160MHz ]
  set_property -dict [ list \
